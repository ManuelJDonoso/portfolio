    ...
    <main class="main">
        ...
        <article class="card card--profile">
          ...
          <div class="card__body">
            ...
            <div class="card__link">
              ...
              <a href="mailto:developer@manueldonoso.es"
                >developer@manueldonoso.es</a
              >
            </div>
            <!-- enlance correo -->
            <div class="card__link">
              <!-- icono font awesome -->
              <i class="fas fa-envelope icon"></i>
              <a href="mailto:proyectos@manueldonoso.es"
                >proyectos@manueldonoso.es</a
              >
            </div>
            <!-- enlance telefono -->
            <div class="card__link">
      ...
      <section class="column column--right">
        ...
        <article class="card card--project">
          <div class="card__image-container">
            <img
              src="assets/images/project_portfolio.jpg"
              alt="Landing page"
              class="card__image"
            />
          </div>
          <div class="project">
            ...
            <h2
              ...
              data-value="first-project-title"
            >
              Landing page
            </h2>
            <p
              class="card__text"
              data-section="Project"
              data-value="first-paragraph-description-p1"
            >
            ...
            <p
              class="card__text"
              data-section="Project"
              data-value="second-paragraph-description-p1"
            >
        ...
        <article class="card card--project">
          ...
          <div class="project">
            ...
            <h2
              class="card__title"
              data-section="Project"
              data-value="second-project-title"
            >
              Landing page
            </h2>
            <p
              class="card__text"
              data-section="Project"
              data-value="first-paragraph-description-p2"
            >
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati
              voluptate soluta, ea eius exercitationem reiciendis quis excepturi
              incidunt nostrum mollitia, aut facilis optio id. Maiores labore
            ...
            <p
              class="card__text"
              data-section="Project"
              data-value="second-paragraph-description-p2"
            >
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Alias,
              ut? Corporis, similique, voluptates nisi amet ducimus omnis natus
              cum dicta, optio accusantium est saepe quisquam illum aut fugit!
        ...
        <article class="card card--project">
          ...
          <div class="project">
            ...
            <h2
              class="card__title"
              data-section="Project"
              data-value="third-project-title"
            >
              Landing page
            </h2>
            <p
              class="card__text"
              data-section="Project"
              data-value="first-paragraph-description-p3"
            >
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati
              voluptate soluta, ea eius exercitationem reiciendis quis excepturi
              incidunt nostrum mollitia, aut facilis optio id. Maiores labore
            ...
            <p
              class="card__text"
              data-section="Project"
              data-value="second-paragraph-description-p3"
            >
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Alias,
              ut? Corporis, similique, voluptates nisi amet ducimus omnis natus
              cum dicta, optio accusantium est saepe quisquam illum aut fugit!
